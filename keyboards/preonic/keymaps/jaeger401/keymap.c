...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_DEL,
...
/* Raise
 * ,-----------------------------------------------------------------------------------.
 * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  | Back | Fwd  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |TabLt |TabRt |   9  |   0  | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_RAISE] = LAYOUT_preonic_grid(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    G(KC_LBRC),G(KC_RBRC),
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6, G(KC_LCBR),G(KC_RCBR),KC_9,   KC_0,    KC_DEL,
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  QWERTY,  _______, _______, _______, _______, _______, _______,
